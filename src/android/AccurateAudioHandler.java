...
public class AccurateAudioHandler extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("startPlayingAudio")) {
            ...
            this.startPlayingAudio(args.getString(0), FileHelper.stripFileProtocol(fileUriStr), args.getDouble(2));
        }
     ...
     */
    public void startPlayingAudio(String id, String file, double when) {
