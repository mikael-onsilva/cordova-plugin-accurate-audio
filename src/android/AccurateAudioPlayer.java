...
public class AccurateAudioPlayer implements OnCompletionListener, OnPreparedListener, OnErrorListener {
    ...
    private static final String LOG_TAG = "AccurateAudioPlayer";

    // AccurateAudioPlayer message ids
     ...
     */
    public AccurateAudioPlayer(AccurateAudioHandler handler, String id, String file) {
    ...
    public void startRecording(String file) {
        switch (this.mode) {
        case PLAY:
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: Can't record in play mode.");
        ...
        case NONE:
            ...
            break;
        case RECORD:
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: Already recording.");
            sendErrorStatus(MEDIA_ERR_ABORTED);
        }
    }
    ...
    public void FuncaoTeste(int when, CallbackContext callbackContext) {
      tempo = when;
    ...
    class RemindTask extends TimerTask {
      public void run() {
        ...
        funcao.success("Função java " + tempo);
        timer.cancel();
      }
    }
    ...
    public void pausePlaying() {
        ...
        if (this.state == STATE.MEDIA_RUNNING && this.player != null) {
            ...
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: pausePlaying() called during invalid state: " + this.state.ordinal());
    ...
    public void stopPlaying() {
        if ((this.state == STATE.MEDIA_RUNNING) || (this.state == STATE.MEDIA_PAUSED)) {
            ...
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: stopPlaying() called during invalid state: " + this.state.ordinal());
            sendErrorStatus(MEDIA_ERR_NONE_ACTIVE);
        }
    }
    ...
    public boolean onError(MediaPlayer player, int arg1, int arg2) {
        LOG.d(LOG_TAG, "AccurateAudioPlayer.onError(" + arg1 + ", " + arg2 + ")");
    ...
    public void setVolume(float volume) {
        if (this.player != null) {
            ...
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: Cannot set volume until the audio file is initialized.");
            sendErrorStatus(MEDIA_ERR_NONE_ACTIVE);
        }
    }
    ...
    private boolean playMode() {
        ...
        case PLAY:
            break;
        case RECORD:
            LOG.d(LOG_TAG, "AccurateAudioPlayer Error: Can't play in record mode.");
            sendErrorStatus(MEDIA_ERR_ABORTED);
        ...
        if (playMode()) {
            switch (this.state) {
                ...
                case MEDIA_LOADING:
                    ...
                    LOG.d(LOG_TAG, "AccurateAudioPlayer Loading: startPlaying() called during media preparation: " + STATE.MEDIA_STARTING.ordinal());
                    this.prepareOnly = false;
                    return false;
                case MEDIA_STARTING:
                case MEDIA_RUNNING:
                ...
                default:
                    LOG.d(LOG_TAG, "AccurateAudioPlayer Error: startPlaying() called during invalid state: " + this.state);
                    sendErrorStatus(MEDIA_ERR_ABORTED);
            }
        }
        return false;
